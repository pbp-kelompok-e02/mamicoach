    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='admin_panel.adminuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_activities', to='admin_panel.adminuser')),
            ],
            options={
                'verbose_name': 'Admin Activity Log',
                'verbose_name_plural': 'Admin Activity Logs',
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['admin_user', '-timestamp'], name='admin_panel_admin_u_61244f_idx'), models.Index(fields=['module', '-timestamp'], name='admin_panel_module_534f8c_idx'), models.Index(fields=['action', '-timestamp'], name='admin_panel_action_49fe2e_idx')],
            },
        ),
    ]
